...
use rust_bot::providers::transcription::{
    GROQ_DEFAULT_MODEL, GroqTranscriptionProvider, OpenAITranscriptionProvider, PathLike,
...
async fn test_openai_transcription_provider() {
    ...
    let response = provider
        .transcribe(PathLike::Path(PathBuf::from("media/world_models.m4a")))
        .await;
